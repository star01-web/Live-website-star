  ...
  return (
    <>
      <div className="fixed bottom-5 right-5 z-50 flex flex-col items-center gap-6 button-floating">
        ...
        <a
          href="https://wa.me/9039023826"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg flex items-center justify-center transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-300 focus:ring-offset-2"
        ...
        {isVisible && (
          <button
            onClick={scrollToTop}
            className="text-black p-4 rounded-full flex items-center justify-center transition-colors duration-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
            aria-label="Scroll to top of page"
            type="button"
          >
           <IoChevronUpCircle className="w-16 h-16" aria-hidden="true" />
          </button>
        )}
      </div>
    </>
